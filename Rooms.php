...
<meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="stylesheet" href="style/romstyle.css">
...
<body>
    ...
    <div class="container">
      <nav>
        <a href="#" class="logo"> <img src="imagess\1s.webp" alt=""> </a>
...
"Book Hotel" cung cấp một nền tảng tiện lợi để nhanh chóng đặt phòng khách sạn trên toàn thế giới, với các tùy chọn tìm kiếm linh hoạt về vị trí, tiện nghi và giá cả.
      ...
      <div class="image">
        <img src="image/home4.jpg" class="slide">
      </div>
      <div class="image_item">
        ...
        <img src="image/home1.jpg" alt="" class="slide" onclick="img('image/home1.jpg')">
      </div>
    </div>
  </section>
  <script>
...
<div class="card one-edge-shadow">
  <img src="img/room1.webp " alt="Denim Jeans" style="width:100%">
  <h1>Couple Room</h1>
  ...
  <button href="">Details Room</button>

</div>

<div class="card classone one-edge-shadow">
  <img src="img/room2.webp " alt="Denim Jeans" style="width:100%">
  <h1>Couple Room</h1>
...
<div class="card classone one-edge-shadow">
  <img src="img/room3.jpg " alt="Denim Jeans" style="width:100%">
  <h1>Couple Room</h1>
...
<div class="card classone one-edge-shadow">
  <img src="img/room4.webp " alt="Denim Jeans" style="width:100%">
  <h1>Couple Room</h1>
  ...
  <button href="http://localhost/php/Roomspage.php">Book Now</button>
  <button href="http://localhost/php/Roomspage.php">Details Room</button>
    ...
    <form action="listroom.php">
    <div class="lg-12">
        <button href="http://localhost/php/listroom.php" class="btn1"  id="myBtn3">More Rooms </button>
        
        <!-- <button class="btn1" onclick="myFunction()" id="myBtn2">More Rooms</button> -->
    </div>
    </form>
      ...
      <div class="content grid">
        <div class="box">
          ...
          <div class="text">
            ...
            <p> <span>$</span>20 <span>/per night</span> </p>
          </div>
        </div>
        <div class="box">
          <div class="img">
          ...
          <div class="text">
            <h3>Superior Soble Rooms</h3>
            <p> <span>$</span>29 <span>/per night</span> </p>
          </div>
        </div>
        <div class="box">
          <div class="img">
          ...
          <div class="text">
            <h3>Superior Soble Rooms</h3>
            <p> <span>$</span>30 <span>/per night</span> </p>
          </div>
        </div>
      </div>
    </div>
...
<div>
  ...
  <script> src="style/romstyle.js"</script>
